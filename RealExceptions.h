...
class RealLibException : public std::exception
{
  ...
  public:
    ...
    virtual const char *kind() const throw() { return "RealLibException"; }
};
...
class PrecisionException : public RealLibException
{
  public:
    ...
    const char *kind() const throw() { return "PrecisionException"; }
};
...
class DomainException : public RealLibException
{
  public:
    ...
    virtual const char *kind() const throw() { return "DomainException"; }
};

static inline std::ostream &operator<<(std::ostream &os, RealLibException &e)
{
